        ...
        "samples": [
            {
                ...
                "temporal": {
                    ...
                    "farrington_expected": (farrington_results or {}).get(r.sample_name, {}).get("expected"),
                    "farrington_threshold": (farrington_results or {}).get(r.sample_name, {}).get("threshold"),
                    "farrington_exceedance": (farrington_results or {}).get(r.sample_name, {}).get("exceedance"),
                    "farrington_alarm": (farrington_results or {}).get(r.sample_name, {}).get("alarm"),
